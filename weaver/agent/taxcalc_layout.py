...
Mirrors weaver.agent.feecalc_layout's shape/rationale: its own module
(NFR-14 scopes weaver.layout to the MVP harness's one oracle fixture),
not a second MVP oracle. Offsets/widths confirmed against a real
GnuCOBOL 3.2.0 run via WSL against fixtures/data_taxcalc/tax.dat,
producing fixtures/data_taxcalc/expected/golden_taxcalc.out (detail line
