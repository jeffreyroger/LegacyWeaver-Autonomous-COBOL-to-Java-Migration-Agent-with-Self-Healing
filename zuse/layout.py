...
Both filled in from zuse/examples/input/copybooks/ACCOUNT-REC.cpy and
interest.cob's detail-line declaration respectively (Steps B1/D3, long
since complete -- NFR-14 is proven by zuse/agent/*_layout.py's five
...
class Field:
    ...
    # Which Java encoder zuse/agent/scaffold.py's report/totals line
...
# Populated per Step B1 -- see zuse/examples/input/copybooks/ACCOUNT-REC.cpy for
...
# zuse/examples/input/interest.cob. Total width 42 bytes (200 detail lines +
