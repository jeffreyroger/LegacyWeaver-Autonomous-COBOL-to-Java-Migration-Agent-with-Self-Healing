...
Reuses weaver.agent.scaffold's generic generator (K2, generalized) with
FEECALC's own field tables (weaver.agent.feecalc_layout) instead of
...
from weaver.agent import feecalc_layout as layout
