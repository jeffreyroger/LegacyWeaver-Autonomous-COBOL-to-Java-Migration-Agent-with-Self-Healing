...
from zuse.agent.cobol_edit import JAVA_SOURCE as COBOL_EDIT_JAVA
from zuse.layout import Field, INPUT_LAYOUT, REPORT_LAYOUT, TOTALS_LAYOUT, record_width
...
# Declared from the 88-levels in zuse/examples/input/copybooks/ACCOUNT-REC.cpy.
...
if __name__ == "__main__":
    ...
    out_path = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("zuse/examples/generated/Scaffold.java")
