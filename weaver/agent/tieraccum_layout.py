...
Mirrors weaver.agent.feecalc_layout/taxcalc_layout's shape/rationale (own
module per NFR-14, not a second MVP oracle). Offsets/widths confirmed
against a real GnuCOBOL 3.2.0 run via WSL against
fixtures/data_tieraccum/tieraccum.dat, producing
fixtures/data_tieraccum/expected/golden_tieraccum.out (detail line 40
...
signal U2 needs -- see weaver/layout.py's Field.edit_style docstring for
