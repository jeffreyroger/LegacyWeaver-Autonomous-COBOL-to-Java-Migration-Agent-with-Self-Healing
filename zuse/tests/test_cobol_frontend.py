...
hand-derived tables in `zuse/layout.py` and the five `*_layout.py` modules,
...
from zuse.agent.feecalc_layout import INPUT_LAYOUT as FEE_INPUT
from zuse.agent.feecalc_layout import REPORT_LAYOUT as FEE_REPORT
from zuse.agent.feecalc_layout import TOTALS_LAYOUT as FEE_TOTALS
from zuse.agent.feecalc_spec import FEECALC_SPEC
from zuse.agent.scaffold import INTEREST_SPEC, generate
from zuse.cobol.data_division import UnsupportedDataItemError
from zuse.cobol.frontend import load_program, to_scaffold_spec
from zuse.cobol.pic import UnsupportedPictureError, parse as parse_pic
from zuse.layout import (
    INPUT_LAYOUT,
    REPORT_LAYOUT,
    TOTALS_LAYOUT,
    Field,
...
INTEREST = Path("zuse/examples/input/interest.cob")
FEECALC = Path("zuse/examples/input/feecalc.cob")
...
def test_prompt_prohibition_text_is_pinned():
    ...
    """
    from zuse.agent.prompt import _prohibitions
...
CORPUS = [
    (
        "feecalc",
        Path("zuse/examples/input/feecalc.cob"),
        "zuse.agent.feecalc_layout",
        "zuse.agent.feecalc_spec",
        "FEECALC_SPEC",
    ),
    (
        "taxcalc",
        Path("zuse/examples/input/taxcalc.cob"),
        "zuse.agent.taxcalc_layout",
        "zuse.agent.taxcalc_spec",
        "TAXCALC_SPEC",
    ),
    (
        "tieraccum",
        Path("zuse/examples/input/tieraccum.cob"),
        "zuse.agent.tieraccum_layout",
        "zuse.agent.tieraccum_spec",
        "TIERACCUM_SPEC",
    ),
    (
        "compound",
        Path("zuse/examples/input/compound.cob"),
        "zuse.agent.compound_layout",
        "zuse.agent.compound_spec",
        "COMPOUND_SPEC",
    ),
    (
        "shipcost",
        Path("zuse/examples/input/shipcost.cob"),
        "zuse.agent.shipcost_layout",
        "zuse.agent.shipcost_spec",
        "SHIPCOST_SPEC",
    ),
]
