...
SCAFFOLD_PATH = Path("zuse/examples/generated/Scaffold.java")
REFERENCE_BODY_PATH = Path("zuse/examples/reference/process_record.body.java")
...
if __name__ == "__main__":
    ...
    result = verify_unit("PROCESS-RECORD", corrupted, _P("zuse/examples/generated/attribution_test"))
