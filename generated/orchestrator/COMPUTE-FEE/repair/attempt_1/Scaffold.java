...
switch (ar.tier()) { case "A": ws.rate = new java.math.BigDecimal("0.01500"); break; case "B": ws.rate = new java.math.BigDecimal("0.01000"); break; default: ws.rate = new java.math.BigDecimal("0.00500"); } ws.fee = ar.balance().multiply(ws.rate).setScale(2, java.math.RoundingMode.DOWN);
