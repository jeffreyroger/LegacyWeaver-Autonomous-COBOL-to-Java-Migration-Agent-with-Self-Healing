...
final class AccountRecord {
    final String id;
    final java.math.BigDecimal weight;
    final String zone;
    final String filler;

    AccountRecord(String id, java.math.BigDecimal weight, String zone, String filler) {
        this.id = id;
        this.weight = weight;
        this.zone = zone;
        this.filler = filler;
    ...
    static AccountRecord decode(String line) {
        return new AccountRecord(
                line.substring(0, 16),
                Scaffold.decodeUnsigned(line.substring(16, 23), 2),
                line.substring(23, 24),
...
final class ReportLine {
    final String id;
    final java.math.BigDecimal weight;
    final java.math.BigDecimal cost;

    ReportLine(String id, java.math.BigDecimal weight, java.math.BigDecimal cost) {
        this.id = id;
        this.weight = weight;
        this.cost = cost;
    }
    ...
    String encode() {
        return Scaffold.pad(id, 16) + CobolEdit.floatingSign(weight, 9, 2) + CobolEdit.floatingSign(cost, 9, 2);
    }
}
...
final class WorkingStorage {
    java.math.BigDecimal cost = java.math.BigDecimal.ZERO.setScale(2);
    java.math.BigDecimal totalCost = java.math.BigDecimal.ZERO.setScale(2);
}

public class Scaffold {
    private static final String INPUT_FILE = "shipcost.dat";
    private static final String OUTPUT_FILE = "shipcost.out";
    ...
    public static void main(String[] args) throws java.io.IOException {
        ...
        for (String rawLine : lines) {
            ...
            computeShipcost(ar, ws);
            ws.totalCost = ws.totalCost.add(ws.cost);

            ReportLine rl = new ReportLine(ar.id, ar.weight, ws.cost);
            // GnuCOBOL LINE SEQUENTIAL strips trailing spaces on WRITE.
            out.append(rstripSpaces(rl.encode())).append("\n");
        }

        TotalsLine tl = new TotalsLine(Scaffold.pad("TOTAL COST:", 30), ws.totalCost, " ");
    ...
    static void computeShipcost(AccountRecord ar, WorkingStorage ws) {
        // PARAGRAPH:COMPUTE-SHIPCOST:BEGIN
if (ar.weight.compareTo(new java.math.BigDecimal("100.00")) > 0 && ar.zone.equals("A")) {
...
} else if (ar.weight.compareTo(new java.math.BigDecimal("100.00")) > 0 && ar.zone.equals("C")) {
    ...
    ws.cost = ar.weight.multiply(new java.math.BigDecimal("0.45")).setScale(2, java.math.RoundingMode.DOWN);
        ...
        // PARAGRAPH:COMPUTE-SHIPCOST:END
    }
}
