...
PROCESS-RECORD body and running the actual repair loop (zuse.agent.
...
STORE_PATH = Path("zuse/examples/generated/failure_memory.json")
...
def seed() -> FailureMemory:
    ...
    memory.cases.append(_seed_case(
        ...
        provenance="Discovered and fixed by zuse.agent.repair_loop.repair_unit on a deliberately "
