...
`weaver.layout.Field` tables the harness compares and the scaffold decodes.
...
Applied to `ACCOUNT-REC.cpy` this reproduces `weaver/layout.py:INPUT_LAYOUT`
...
from weaver.cobol.naming import java_condition_name
from weaver.cobol.pic import Picture, UnsupportedPictureError, parse as parse_picture
from weaver.cobol.source import Statement
