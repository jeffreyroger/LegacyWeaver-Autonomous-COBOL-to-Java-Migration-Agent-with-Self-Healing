...
from zuse.agent.memory import FailureMemory
from zuse.agent.repair_deterministic import patch_sign
...
if __name__ == "__main__":
    import time
    from zuse.classification import DefectClass
    from zuse.agent.seed_memory import STORE_PATH as SEED_STORE_PATH
    ...
    fresh_body = Path("zuse/examples/generated/o3_case_b_body.java").read_text(encoding="utf-8")  # same .negate() defect, fresh instance
    ...
    result, case_id = try_memory_repair(
        ...
        "MOVE WS-INTEREST TO RL-INTEREST", Path("zuse/examples/generated/o2_memory_repair_test"),
    )
