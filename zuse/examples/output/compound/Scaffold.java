...
final class AccountRecord {
    final String id;
    final java.math.BigDecimal principal;
    final String filler;

    AccountRecord(String id, java.math.BigDecimal principal, String filler) {
        this.id = id;
...
final class ReportLine {
    ...
    ReportLine(String id, java.math.BigDecimal principal, java.math.BigDecimal result) {
        this.id = id;
        this.principal = principal;
        this.result = result;
    }
    ...
    String encode() {
        return Scaffold.pad(id, 16) + CobolEdit.floatingSign(principal, 13, 2) + CobolEdit.floatingSign(result, 11, 2);
    }
}
...
final class WorkingStorage {
    java.math.BigDecimal step1 = java.math.BigDecimal.ZERO.setScale(2);
    java.math.BigDecimal step2 = java.math.BigDecimal.ZERO.setScale(2);
    java.math.BigDecimal step3 = java.math.BigDecimal.ZERO.setScale(2);
    java.math.BigDecimal step4 = java.math.BigDecimal.ZERO.setScale(2);
    java.math.BigDecimal result = java.math.BigDecimal.ZERO.setScale(2);
    java.math.BigDecimal totalResult = java.math.BigDecimal.ZERO.setScale(2);
}

public class Scaffold {
    private static final String INPUT_FILE = "compound.dat";
    private static final String OUTPUT_FILE = "compound.out";
    ...
    public static void main(String[] args) throws java.io.IOException {
        ...
        for (String rawLine : lines) {
            ...
            computeCompound(ar, ws);
            ws.totalResult = ws.totalResult.add(ws.result);

            ReportLine rl = new ReportLine(ar.id, ar.principal, ws.result);
            // GnuCOBOL LINE SEQUENTIAL strips trailing spaces on WRITE.
            out.append(rstripSpaces(rl.encode())).append("\n");
        }

        TotalsLine tl = new TotalsLine(Scaffold.pad("TOTAL RESULT:", 30), ws.totalResult, " ");
    ...
    static void computeCompound(AccountRecord ar, WorkingStorage ws) {
        // PARAGRAPH:COMPUTE-COMPOUND:BEGIN
ws.step1 = ar.principal.multiply(new java.math.BigDecimal("0.05")).setScale(2, java.math.RoundingMode.DOWN);
ws.step2 = ws.step1.add(ar.principal).setScale(2, java.math.RoundingMode.DOWN);
ws.step3 = ws.step2.multiply(new java.math.BigDecimal("0.03")).setScale(2, java.math.RoundingMode.DOWN);
ws.step4 = ar.principal.multiply(new java.math.BigDecimal("0.01")).setScale(2, java.math.RoundingMode.DOWN);
ws.result = ws.step2.add(ws.step3).subtract(ws.step4).setScale(2, java.math.RoundingMode.DOWN);
        // PARAGRAPH:COMPUTE-COMPOUND:END
    }
}
