...
Mirrors weaver.layout's shape (Field/INPUT_LAYOUT/REPORT_LAYOUT/
TOTALS_LAYOUT) but is deliberately its own module: weaver.layout is scoped
...
Derived from fixtures/cobol_feecalc/copybooks/FEE-REC.cpy and
fixtures/cobol_feecalc/feecalc.cob's FEE-REPORT-LINE/FEE-TOTALS-LINE,
cross-checked against fixtures/data_feecalc/expected/golden_feecalc.out
...
from weaver.layout import Field, record_width  # reuse the same Field dataclass
