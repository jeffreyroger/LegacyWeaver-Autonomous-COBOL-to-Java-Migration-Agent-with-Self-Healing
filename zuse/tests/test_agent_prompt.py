...
from zuse.agent.prompt import build_synthesis_prompt
...
def _process_record_paragraph():
    src = Path("zuse/examples/input/interest.cob").read_text()
...
def test_repair_prompt_also_lists_scaffold_owned_statements():
    from zuse.agent.repair_model import build_repair_prompt
